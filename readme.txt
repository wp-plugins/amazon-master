...
* Display or hide Amazon Deals
* Insert desired amazon ad (allows api ads styling)
...
* [Advanced Version Link](http://wordpress.techgasp.com/amazon-master/)

**ONLINE DEMO**

* Right of the page, sidebar widget
* Inside the post, with shortcode framework v2
* [Demo Link](http://wordpress.techgasp.com/amazon-master)
...
3. Visit the "Widget Page | Amazon Master" to configure the settings and your template widget position.
4. [Amazon Master Documentation](http://wordpress.techgasp.com/amazon-master-documentation/)
...
* [Advanced Version Link](http://wordpress.techgasp.com/amazon-master/)
* Insert the code into the page or post. [amazon-master]
...
= Need More Help =
* [Amazon Master Documentation](http://wordpress.techgasp.com/amazon-master-documentation)
...
= 1.5 =
* IMPORTANT Beta Release, if you helped us test the Plugin, upgrade to Stable release
